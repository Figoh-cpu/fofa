...
"数字频道":[
"金鹰纪实", "金鹰卡通", "快乐垂钓", "茶频道", "求索纪录", "中国天气", "天元围棋", "睛彩竞技", "睛彩篮球", "睛彩青少年", "睛彩广场舞", "纪实科教""魅力足球", "五星体育","劲爆体育""先锋乒羽", "汽摩", "梨园频道", "文物宝库", "武术世界", "哒啵赛事", "哒啵电竞", "黑莓电影", "黑莓动画","乐游", "生活时尚", "都市剧场", "欢笑剧场", "游戏风云", "金色学堂", "动漫秀场", "新动漫", "卡酷少儿", "优漫卡通", "哈哈炫动", "嘉佳卡通","中国交通", "中国天气", "华数4K", "华数星影", "华数动作影院", "华数喜剧影院", "华数家庭影院", "华数经典电影", "华数热播剧场", "华数碟战剧场","华数军旅剧场", "华数城市剧场", "华数武侠剧场", "华数古装剧场", "华数魅力时尚", "华数少儿动画", "华数动画"
],
"北京频道":[
"北京IPTV4K超清","北京IPTV淘电影","北京IPTV淘剧场","北京IPTV淘精彩","北京IPTV淘娱乐","北京IPTV淘BABY","北京IPTV萌宠TV","北京IPTV重温经典","北京纪实科教","北京卡酷少儿","北京体育休闲","北京文艺频道","北京影视频道","北京财经频道","北京生活频道","北京新闻频道","北京国际频道"
],
"上海频道":[
"上海新闻综合","上海第一财经","上海东方财经","上海东方影视","上海哈哈炫动","上海五星体育","上海劲爆体育","上海都市频道","上海教育教育","上海纪实人文","上海都市剧场","上海都市剧场4K","上海欢笑剧场","上海欢笑剧场4K","上海动漫秀场","上海动漫秀场4K","上海乐游频道","上海法治天地","上海金色学堂","上海游戏风云","上海生活时尚"
],
"广东频道":[
...
def third_stage():
    print("🧩 第三阶段：多线程检测代表频道生成 tv.txt（支持 rtp 和 udp 格式）")
    ...
    print(f"🎯 tv.txt 生成完成（含更新时间），共 {len(valid_lines)} 条频道（包含 rtp 和 udp 格式）")
